...
A webgl2 renderer that uses [Shipyard ECS](https://github.com/leudz/shipyard) for the core entity-component-system engine and [awsm-web](https://github.com/dakom/awsm-web) for web api helpers.
