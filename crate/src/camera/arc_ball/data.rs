...
impl ArcBall {
    ...
    pub fn new(eye: Point3<f64>, at: Point3<f64>) -> ArcBall {
        ArcBall::new_with_frustrum(f64::consts::PI / 4.0, 0.1, DEFAULT_ARCBALL_FAR_PLANE, eye, at)
    }
